<x-layout>
    {{-- 1 — Hero --}}
    <section class="relative flex min-h-[100svh] flex-col bg-ink">
        ...
        <div class="relative flex flex-1 flex-col px-4 pb-8 pt-28 md:px-5 md:pb-16 md:pt-32">
    ...
    <section class="bg-ink px-4 py-24 md:px-5 md:py-32">
        <h1 class="max-w-[16ch] text-section">Work gains value through placement</h1>
        <p class="mt-8 max-w-3xl text-lg font-bold uppercase leading-[1.05] tracking-[-0.03em] text-muted md:text-2xl">
        ...
        @if ($articles->isNotEmpty())
            <ul class="mt-16 grid grid-cols-2 gap-1 md:grid-cols-3">
                @foreach ($articles as $article)
                    <li>
                        <a href="{{ route('fashion') }}" class="group block aspect-[3/4] overflow-hidden bg-[#161616]"
        ...
        <div class="mt-14 flex justify-center">
            <x-cta-button :href="route('fashion')" class="w-full max-w-[740px]">More Fashion</x-cta-button>
        </div>
    </section>
    ...
    <section class="bg-ink px-4 py-24 md:px-5 md:py-32">
        ...
        <p class="mt-6 max-w-4xl text-lg font-bold uppercase leading-[1.05] tracking-[-0.03em] text-muted md:text-2xl">
    ...
    <section class="bg-ink px-4 py-24 md:px-5 md:py-32">
        <h2 class="text-section">Print Editions</h2>

        <div class="mx-auto mt-12 aspect-[4/5] w-full max-w-[860px] overflow-hidden bg-[#161616]">
        ...
        <div class="mt-16 max-w-4xl">
            <p class="text-2xl capitalize leading-[0.9] tracking-[-0.04em] md:text-[40px]">
                In a fast digital world, print becomes a form of quiet luxury
            </p>
            <p class="mt-6 text-lg font-bold uppercase leading-[1.05] tracking-[-0.03em] text-muted md:text-2xl">
        ...
        <div class="mt-14 flex justify-center">
            <x-cta-button :href="route('print')" class="w-full max-w-[740px]">View Print Editions</x-cta-button>
        </div>
    </section>
    ...
    <section class="bg-ink px-4 py-24 text-center md:px-5 md:py-32">
        ...
        <p class="mx-auto mt-20 flex max-w-6xl flex-col items-center gap-y-1 text-statement uppercase leading-[0.95] md:flex-row md:flex-wrap md:justify-center md:gap-x-10">
